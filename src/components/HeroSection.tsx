...
const WA_URL =
  'https://wa.me/628568056469?text=' +
  encodeURIComponent(
    'Halo, saya mau pesan untuk acara. Bisa info lebih lanjut?'
  );
  ...
  return (
    <section className="mx-4 my-4 rounded-2xl bg-gradient-to-br from-[#5C4033] to-[#3D2B1F] p-6 text-white">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-white text-warm-text font-semibold px-5 py-2.5 rounded-full text-sm hover:bg-warm-bg transition-colors"
      >
        <svg
        ...
        Pesan via WhatsApp
        <ChevronRight className="w-4 h-4 text-warm-text-muted" />
      </a>
    </section>
  );
}
